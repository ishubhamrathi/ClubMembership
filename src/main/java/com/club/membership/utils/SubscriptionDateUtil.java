...
public final class SubscriptionDateUtil {
    ...
    public static LocalDateTime calculateExpiryDate(
            BillingCycle billingCycle, LocalDateTime subscribedAt) {

        return switch (billingCycle) {
            case MONTHLY -> subscribedAt.plusMonths(1);

            case QUARTERLY -> subscribedAt.plusMonths(3);

            case YEARLY -> subscribedAt.plusYears(1);
        };
    }
}
