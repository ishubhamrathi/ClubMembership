...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleResourceNotFound(ResourceNotFoundException ex) {
        ErrorResponse response =
                new ErrorResponse("Not Found", ex.getMessage(), LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleInvalidTier(InvalidTierException ex) {
        ErrorResponse response =
                new ErrorResponse("Bad Request", ex.getMessage(), LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleValidationException(
        ...
        ErrorResponse response =
                new ErrorResponse("Validation Failed", message, LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleNotReadable(HttpMessageNotReadableException ex) {
        ErrorResponse response =
                new ErrorResponse("Bad Request", "Malformed request body", LocalDateTime.now());
